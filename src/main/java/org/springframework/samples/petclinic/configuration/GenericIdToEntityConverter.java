...
public final class GenericIdToEntityConverter implements ConditionalGenericConverter {
	...
	public boolean matches(TypeDescriptor sourceType, TypeDescriptor targetType) {
		return BaseEntity.class.isAssignableFrom(targetType.getType()) && this.conversionService
				.canConvert(sourceType, TypeDescriptor.valueOf(Integer.class));
	}
	...
	public Object convert(Object source, TypeDescriptor sourceType, TypeDescriptor targetType) {
		...
		Integer id = (Integer) this.conversionService.convert(source, sourceType,
